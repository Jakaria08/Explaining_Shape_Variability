...
if __name__ == '__main__':
    main([
        ...
        '--latent_channels', '12',
        '--n_trials', '100',
        '--trial_metrics_fp', '/home/jakaria/Explaining_Shape_Variability/src/DeepLearning/compute_canada/guided_vae/data/CoMA/raw/calsnic_als/models/trial_metrics_gpu1_latent12.txt',
